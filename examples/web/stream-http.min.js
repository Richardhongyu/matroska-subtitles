!function (f) {if ('object' == typeof exports && 'undefined' != typeof module) module.exports = f() else if ('function' == typeof define && define.amd) define([], f) else {('undefined' != typeof window ? window : 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : this).httpStream = f()}}((function () {
  return function e (t, n, r) {
    ...
    3: [function (require, module, exports) {
      ...
      function createErrorType (code, message, Base) {
        ...
        var NodeError = function (_Base) {
          ...
          function NodeError (arg1, arg2, arg3) {return _Base.call(this, function (arg1, arg2, arg3) {return 'string' == typeof message ? message : message(arg1, arg2, arg3)}(arg1, arg2, arg3)) || this}
      ...
      function oneOf (expected, thing) {
        if (Array.isArray(expected)) {
          ...
          return expected = expected.map((function (i) {return String(i)})), len > 2 ? 'one of '.concat(thing, ' ').concat(expected.slice(0, len - 1).join(', '), ', or ') + expected[len - 1] : 2 === len ? 'one of '.concat(thing, ' ').concat(expected[0], ' or ').concat(expected[1]) : 'of '.concat(thing, ' ').concat(expected[0])
        }
        return 'of '.concat(thing, ' ').concat(String(expected))
      }

      createErrorType('ERR_INVALID_OPT_VALUE', (function (name, value) {return 'The value "' + value + '" is invalid for option "' + name + '"'}), TypeError), createErrorType('ERR_INVALID_ARG_TYPE', (function (name, expected, actual) {
        var determiner, search, pos, msg
        if ('string' == typeof expected && (search = 'not ', expected.substr(!pos || pos < 0 ? 0 : +pos, search.length) === search) ? (determiner = 'must not be', expected = expected.replace(/^not /, '')) : determiner = 'must be', function (str, search, this_len) {return (void 0 === this_len || this_len > str.length) && (this_len = str.length), str.substring(this_len - search.length, this_len) === search}(name, ' argument')) msg = 'The '.concat(name, ' ').concat(determiner, ' ').concat(oneOf(expected, 'type')) else {
          var type = function (str, search, start) {return 'number' != typeof start && (start = 0), !(start + search.length > str.length) && -1 !== str.indexOf(search, start)}(name, '.') ? 'property' : 'argument'
    ...
    4: [function (require, module, exports) {
      (function (process) {
        ...
        function onend () {this._writableState.ended || process.nextTick(onEndNT, this)}
        ...
        Object.defineProperty(Duplex.prototype, 'writableHighWaterMark', {
          ...
          enumerable: !1,
          get: function () {return this._writableState && this._writableState.getBuffer()}
        }), Object.defineProperty(Duplex.prototype, 'writableLength', {
          enumerable: !1,
          get: function () {return this._writableState.length}
        }), Object.defineProperty(Duplex.prototype, 'destroyed', {
          enumerable: !1,
          get: function () {return void 0 !== this._readableState && void 0 !== this._writableState && (this._readableState.destroyed && this._writableState.destroyed)},
          set: function (value) {void 0 !== this._readableState && void 0 !== this._writableState && (this._readableState.destroyed = value, this._writableState.destroyed = value)}
        })
      }).call(this, require('_process'))
    }, { './_stream_readable': 6, './_stream_writable': 8, _process: 32, inherits: 2 }],
    5: [function (require, module, exports) {
      ...
      require('inherits')(PassThrough, Transform), PassThrough.prototype._transform = function (chunk, encoding, cb) {cb(null, chunk)}
    }, { './_stream_transform': 7, inherits: 2 }],
    6: [function (require, module, exports) {
      (function (process, global) {
        ...
        var EElistenerCount = function (emitter, type) {return emitter.listeners(type).length},
          Stream = require('./internal/streams/stream'), Buffer = require('buffer').Buffer,
          OurUint8Array = global.Uint8Array || function () {}
        var debug, debugUtil = require('util')
        debug = debugUtil && debugUtil.debuglog ? debugUtil.debuglog('stream') : function () {}
        var StringDecoder, createReadableStreamAsyncIterator, from,
          BufferList = require('./internal/streams/buffer_list'), destroyImpl = require('./internal/streams/destroy'),
          getHighWaterMark = require('./internal/streams/state').getHighWaterMark,
          _require$codes = require('../errors').codes, ERR_INVALID_ARG_TYPE = _require$codes.ERR_INVALID_ARG_TYPE,
        ...
        Object.defineProperty(Readable.prototype, 'destroyed', {
          enumerable: !1,
          get: function () {return void 0 !== this._readableState && this._readableState.destroyed},
          set: function (value) {this._readableState && (this._readableState.destroyed = value)}
        }), Readable.prototype.destroy = destroyImpl.destroy, Readable.prototype._undestroy = destroyImpl.undestroy, Readable.prototype._destroy = function (err, cb) {cb(err)}, Readable.prototype.push = function (chunk, encoding) {
        ...
        }, Readable.prototype.unshift = function (chunk) {return readableAddChunk(this, chunk, null, !0, !1)}, Readable.prototype.isPaused = function () {return !1 === this._readableState.flowing}, Readable.prototype.setEncoding = function (enc) {
        ...
        function maybeReadMore (stream, state) {state.readingMore || (state.readingMore = !0, process.nextTick(maybeReadMore_, stream, state))}
        ...
        function resume_ (stream, state) {debug('resume', state.reading), state.reading || stream.read(0), state.resumeScheduled = !1, stream.emit('resume'), flow(stream), state.flowing && !state.reading && stream.read(0)}
        ...
        Readable.prototype.read = function (n) {
        ...
        }, Readable.prototype._read = function (n) {errorOrDestroy(this, new ERR_METHOD_NOT_IMPLEMENTED('_read()'))}, Readable.prototype.pipe = function (dest, pipeOpts) {
          ...
          function onerror (er) {debug('onerror', er), unpipe(), dest.removeListener('error', onerror), 0 === EElistenerCount(dest, 'error') && errorOrDestroy(dest, er)}
          ...
          return state.flowing || (debug('resume'), state.flowing = !state.readableListening, function (stream, state) {state.resumeScheduled || (state.resumeScheduled = !0, process.nextTick(resume_, stream, state))}(this, state)), state.paused = !1, this
        }, Readable.prototype.pause = function () {return debug('call pause flowing=%j', this._readableState.flowing), !1 !== this._readableState.flowing && (debug('pause'), this._readableState.flowing = !1, this.emit('pause')), this._readableState.paused = !0, this}, Readable.prototype.wrap = function (stream) {
          ...
          for (var i in stream.on('end', (function () {
            ...
            _this.push(null)
          })), stream.on('data', (function (chunk) {(debug('wrapped data'), state.decoder && (chunk = state.decoder.write(chunk)), state.objectMode && null == chunk) || (state.objectMode || chunk && chunk.length) && (_this.push(chunk) || (paused = !0, stream.pause()))})), stream) void 0 === this[i] && 'function' == typeof stream[i] && (this[i] = function (method) {return function () {return stream[method].apply(stream, arguments)}}(i))
          for (var n = 0; n < kProxyEvents.length; n++) stream.on(kProxyEvents[n], this.emit.bind(this, kProxyEvents[n]))
          return this._read = function (n) {debug('wrapped _read', n), paused && (paused = !1, stream.resume())}, this
        }, 'function' == typeof Symbol && (Readable.prototype[Symbol.asyncIterator] = function () {return void 0 === createReadableStreamAsyncIterator && (createReadableStreamAsyncIterator = require('./internal/streams/async_iterator')), createReadableStreamAsyncIterator(this)}), Object.defineProperty(Readable.prototype, 'readableHighWaterMark', {
          enumerable: !1,
          ...
          set: function (state) {this._readableState && (this._readableState.flowing = state)}
        ...
        }), 'function' == typeof Symbol && (Readable.from = function (iterable, opts) {return void 0 === from && (from = require('./internal/streams/from')), from(Readable, iterable, opts)})
      }).call(this, require('_process'), 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : {})
    }, {
      '../errors': 3,
      './_stream_duplex': 4,
      './internal/streams/async_iterator': 9,
      './internal/streams/buffer_list': 10,
      './internal/streams/destroy': 11,
      './internal/streams/from': 13,
      './internal/streams/state': 15,
      './internal/streams/stream': 16,
      _process: 32,
      buffer: 28,
      events: 29,
      inherits: 2,
    ...
    7: [function (require, module, exports) {
      ...
      var _require$codes = require('../errors').codes,
        ...
        ERR_TRANSFORM_WITH_LENGTH_0 = _require$codes.ERR_TRANSFORM_WITH_LENGTH_0, Duplex = require('./_stream_duplex')
      ...
      function prefinish () {
        var _this = this
        'function' != typeof this._flush || this._readableState.destroyed ? done(this, null, null) : this._flush((function (er, data) {done(_this, er, data)}))
      }
      ...
      require('inherits')(Transform, Duplex), Transform.prototype.push = function (chunk, encoding) {return this._transformState.needTransform = !1, Duplex.prototype.push.call(this, chunk, encoding)}, Transform.prototype._transform = function (chunk, encoding, cb) {cb(new ERR_METHOD_NOT_IMPLEMENTED('_transform()'))}, Transform.prototype._write = function (chunk, encoding, cb) {
        var ts = this._transformState
      ...
      }, Transform.prototype._destroy = function (err, cb) {Duplex.prototype._destroy.call(this, err, (function (err2) {cb(err2)}))}
    }, { '../errors': 3, './_stream_duplex': 4, inherits: 2 }],
    8: [function (require, module, exports) {
      (function (process, global) {
        ...
        var internalUtil = { deprecate: require('util-deprecate') }, Stream = require('./internal/streams/stream'),
          Buffer = require('buffer').Buffer, OurUint8Array = global.Uint8Array || function () {}
        var realHasInstance, destroyImpl = require('./internal/streams/destroy'),
          ...
          ERR_UNKNOWN_ENCODING = _require$codes.ERR_UNKNOWN_ENCODING, errorOrDestroy = destroyImpl.errorOrDestroy
        ...
        function doWrite (stream, state, writev, len, chunk, encoding, cb) {state.writelen = len, state.writecb = cb, state.writing = !0, state.sync = !0, state.destroyed ? state.onwrite(new ERR_STREAM_DESTROYED('write')) : writev ? stream._writev(chunk, state.onwrite) : stream._write(chunk, encoding, state.onwrite), state.sync = !1}
        ...
        function callFinal (stream, state) {stream._final((function (err) {state.pendingcb--, err && errorOrDestroy(stream, err), state.prefinished = !0, stream.emit('prefinish'), finishMaybe(stream, state)}))}

        function finishMaybe (stream, state) {
          var need = needFinish(state)
          if (need && (function (stream, state) {state.prefinished || state.finalCalled || ('function' != typeof stream._final || state.destroyed ? (state.prefinished = !0, stream.emit('prefinish')) : (state.pendingcb++, state.finalCalled = !0, process.nextTick(callFinal, stream, state)))}(stream, state), 0 === state.pendingcb && (state.finished = !0, stream.emit('finish'), state.autoDestroy))) {
        ...
        require('inherits')(Writable, Stream), WritableState.prototype.getBuffer = function () {
          ...
          var obj, state = this._writableState, ret = !1,
            isBuf = !state.objectMode && (obj = chunk, Buffer.isBuffer(obj) || obj instanceof OurUint8Array)
          return isBuf && !Buffer.isBuffer(chunk) && (chunk = function (chunk) {return Buffer.from(chunk)}(chunk)), 'function' == typeof encoding && (cb = encoding, encoding = null), isBuf ? encoding = 'buffer' : encoding || (encoding = state.defaultEncoding), 'function' != typeof cb && (cb = nop), state.ending ? function (stream, cb) {
            var er = new ERR_STREAM_WRITE_AFTER_END
            errorOrDestroy(stream, er), process.nextTick(cb, er)
          }(this, cb) : (isBuf || function (stream, state, chunk, cb) {
            var er
            return null === chunk ? er = new ERR_STREAM_NULL_VALUES : 'string' == typeof chunk || state.objectMode || (er = new ERR_INVALID_ARG_TYPE('chunk', ['string', 'Buffer'], chunk)), !er || (errorOrDestroy(stream, er), process.nextTick(cb, er), !1)
          ...
          enumerable: !1,
          get: function () {return this._writableState.highWaterMark}
        }), Writable.prototype._write = function (chunk, encoding, cb) {cb(new ERR_METHOD_NOT_IMPLEMENTED('_write()'))}, Writable.prototype._writev = null, Writable.prototype.end = function (chunk, encoding, cb) {
          var state = this._writableState
          return 'function' == typeof chunk ? (cb = chunk, chunk = null, encoding = null) : 'function' == typeof encoding && (cb = encoding, encoding = null), null != chunk && this.write(chunk, encoding), state.corked && (state.corked = 1, this.uncork()), state.ending || function (stream, state, cb) {
          ...
          enumerable: !1,
          get: function () {return void 0 !== this._writableState && this._writableState.destroyed},
          set: function (value) {this._writableState && (this._writableState.destroyed = value)}
        }), Writable.prototype.destroy = destroyImpl.destroy, Writable.prototype._undestroy = destroyImpl.undestroy, Writable.prototype._destroy = function (err, cb) {cb(err)}
      }).call(this, require('_process'), 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : {})
    }, {
      '../errors': 3,
      './_stream_duplex': 4,
    ...
    9: [function (require, module, exports) {
      (function (process) {
        ...
        var finished = require('./end-of-stream'), kLastResolve = Symbol('lastResolve'),
          kLastReject = Symbol('lastReject'), kError = Symbol('error'), kEnded = Symbol('ended'),
          kLastPromise = Symbol('lastPromise'), kHandlePromise = Symbol('handlePromise'), kStream = Symbol('stream')
        ...
        var AsyncIteratorPrototype = Object.getPrototypeOf((function () {})),
          ReadableStreamAsyncIteratorPrototype = Object.setPrototypeOf((_defineProperty(_Object$setPrototypeO = {
            ...
            next: function () {
              ...
              if (lastPromise) promise = new Promise(function (lastPromise, iter) {return function (resolve, reject) {lastPromise.then((function () {iter[kEnded] ? resolve(createIterResult(void 0, !0)) : iter[kHandlePromise](resolve, reject)}), reject)}}(lastPromise, this)) else {
          ...
          }, Symbol.asyncIterator, (function () {return this})), _defineProperty(_Object$setPrototypeO, 'return', (function () {
            var _this2 = this
            return new Promise((function (resolve, reject) {_this2[kStream].destroy(null, (function (err) {err ? reject(err) : resolve(createIterResult(void 0, !0))}))}))
          })), _Object$setPrototypeO), AsyncIteratorPrototype)
        module.exports = function (stream) {
          var _Object$create,
            iterator = Object.create(ReadableStreamAsyncIteratorPrototype, (_defineProperty(_Object$create = {}, kStream, {
              value: stream,
              writable: !0
    ...
    10: [function (require, module, exports) {
      ...
      var Buffer = require('buffer').Buffer, inspect = require('util').inspect,
      ...
      module.exports = function () {
        ...
        return Constructor = BufferList, (protoProps = [{
          ...
          key: 'consume', value: function (n, hasStrings) {
            var ret
          ...
          key: '_getBuffer', value: function (n) {
        ...
        }]) && _defineProperties(Constructor.prototype, protoProps), staticProps && _defineProperties(Constructor, staticProps), BufferList
      }()
    }, { buffer: 28, util: 27 }],
    11: [function (require, module, exports) {
      (function (process) {
        ...
        function emitCloseNT (self) {self._writableState && !self._writableState.emitClose || self._readableState && !self._readableState.emitClose || self.emit('close')}
        ...
        module.exports = {
          destroy: function (err, cb) {
            ...
            return readableDestroyed || writableDestroyed ? (cb ? cb(err) : err && (this._writableState ? this._writableState.errorEmitted || (this._writableState.errorEmitted = !0, process.nextTick(emitErrorNT, this, err)) : process.nextTick(emitErrorNT, this, err)), this) : (this._readableState && (this._readableState.destroyed = !0), this._writableState && (this._writableState.destroyed = !0), this._destroy(err || null, (function (err) {!cb && err ? _this._writableState ? _this._writableState.errorEmitted ? process.nextTick(emitCloseNT, _this) : (_this._writableState.errorEmitted = !0, process.nextTick(emitErrorAndCloseNT, _this, err)) : process.nextTick(emitErrorAndCloseNT, _this, err) : cb ? (process.nextTick(emitCloseNT, _this), cb(err)) : process.nextTick(emitCloseNT, _this)})), this)
          },
    ...
    12: [function (require, module, exports) {
      ...
      module.exports = function eos (stream, opts, callback) {
        ...
        var readable = opts.readable || !1 !== opts.readable && stream.readable,
          ...
          onlegacyfinish = function () {stream.writable || onfinish()},
          writableEnded = stream._writableState && stream._writableState.finished,
          onfinish = function () {writable = !1, writableEnded = !0, readable || callback.call(stream)},
          readableEnded = stream._readableState && stream._readableState.endEmitted,
          onend = function () {readable = !1, readableEnded = !0, writable || callback.call(stream)},
          onerror = function (err) {callback.call(stream, err)}, onclose = function () {
            var err
    ...
    13: [function (require, module, exports) {module.exports = function () {throw new Error('Readable.from is not available in the browser')}}, {}],
    14: [function (require, module, exports) {
      'use strict'
      var eos
      var _require$codes = require('../../../errors').codes, ERR_MISSING_ARGS = _require$codes.ERR_MISSING_ARGS,
        ERR_STREAM_DESTROYED = _require$codes.ERR_STREAM_DESTROYED
      ...
      function destroyer (stream, reading, writing, callback) {
        callback = function (callback) {
          var called = !1
          return function () {called || (called = !0, callback.apply(void 0, arguments))}
        }(callback)
        var closed = !1
        stream.on('close', (function () {closed = !0})), void 0 === eos && (eos = require('./end-of-stream')), eos(stream, {
          readable: reading,
          writable: writing
        }, (function (err) {
        ...
        var destroyed = !1
        return function (err) {if (!closed && !destroyed) return destroyed = !0, function (stream) {return stream.setHeader && 'function' == typeof stream.abort}(stream) ? stream.abort() : 'function' == typeof stream.destroy ? stream.destroy() : void callback(err || new ERR_STREAM_DESTROYED('pipe'))}
      }
      ...
      function popCallback (streams) {return streams.length ? 'function' != typeof streams[streams.length - 1] ? noop : streams.pop() : noop}
    ...
    }, { '../../../errors': 3, './end-of-stream': 12 }],
    15: [function (require, module, exports) {
      'use strict'
      var ERR_INVALID_OPT_VALUE = require('../../../errors').codes.ERR_INVALID_OPT_VALUE
      module.exports = {
        getHighWaterMark: function (state, options, duplexKey, isDuplex) {
          var hwm = function (options, isDuplex, duplexKey) {return null != options.highWaterMark ? options.highWaterMark : isDuplex ? options[duplexKey] : null}(options, isDuplex, duplexKey)
          if (null != hwm) {
    ...
    16: [function (require, module, exports) {module.exports = require('events').EventEmitter}, { events: 29 }],
    17: [function (require, module, exports) {(exports = module.exports = require('./lib/_stream_readable.js')).Stream = exports, exports.Readable = exports, exports.Writable = require('./lib/_stream_writable.js'), exports.Duplex = require('./lib/_stream_duplex.js'), exports.Transform = require('./lib/_stream_transform.js'), exports.PassThrough = require('./lib/_stream_passthrough.js'), exports.finished = require('./lib/internal/streams/end-of-stream.js'), exports.pipeline = require('./lib/internal/streams/pipeline.js')}, {
      ...
      './lib/_stream_passthrough.js': 5,
      './lib/_stream_readable.js': 6,
      './lib/_stream_transform.js': 7,
      './lib/_stream_writable.js': 8,
      './lib/internal/streams/end-of-stream.js': 12,
      ...
      (function (global) {
        ...
        function getXHR () {
          ...
          if (global.XMLHttpRequest) {
            ...
            try {xhr.open('GET', global.XDomainRequest ? '/' : 'https://example.com')} catch (e) {xhr = null}
          } else xhr = null
          return xhr
        }
        ...
        function checkTypeSupport (type) {
          var xhr = getXHR()
          if (!xhr) return !1
          try {return xhr.responseType = type, xhr.responseType === type} catch (e) {}
          return !1
        }
    ...
    20: [function (require, module, exports) {
      (function (process, global, Buffer) {
        var capability = require('./capability'), inherits = require('inherits'), response = require('./response'),
          stream = require('readable-stream'), IncomingMessage = response.IncomingMessage,
          rStates = response.readyStates
        var ClientRequest = module.exports = function (opts) {
          var preferBinary, self = this
          stream.Writable.call(self), self._opts = opts, self._body = [], self._headers = {}, opts.auth && self.setHeader('Authorization', 'Basic ' + Buffer.from(opts.auth).toString('base64')), Object.keys(opts.headers).forEach((function (name) {self.setHeader(name, opts.headers[name])}))
          var useFetch = !0
          if ('disable-fetch' === opts.mode || 'requestTimeout' in opts && !capability.abortController) useFetch = !1, preferBinary = !0 else if ('prefer-streaming' === opts.mode) preferBinary = !1 else if ('allow-wrong-content-type' === opts.mode) preferBinary = !capability.overrideMimeType else {
            if (opts.mode && 'default' !== opts.mode && 'prefer-fast' !== opts.mode) throw new Error('Invalid value for opts.mode')
            preferBinary = !0
          }
          self._mode = function (preferBinary, useFetch) {return capability.fetch && useFetch ? 'fetch' : capability.mozchunkedarraybuffer ? 'moz-chunked-arraybuffer' : capability.msstream ? 'ms-stream' : capability.arraybuffer && preferBinary ? 'arraybuffer' : 'text'}(preferBinary, useFetch), self._fetchTimer = null, self.on('finish', (function () {self._onFinish()}))
        }
        inherits(ClientRequest, stream.Writable), ClientRequest.prototype.setHeader = function (name, value) {
          var lowerName = name.toLowerCase();
          -1 === unsafeHeaders.indexOf(lowerName) && (this._headers[lowerName] = { name: name, value: value })
        }, ClientRequest.prototype.getHeader = function (name) {
          var header = this._headers[name.toLowerCase()]
          return header ? header.value : null
        }, ClientRequest.prototype.removeHeader = function (name) {delete this._headers[name.toLowerCase()]}, ClientRequest.prototype._onFinish = function () {
          var self = this
          if (!self._destroyed) {
            var opts = self._opts, headersObj = self._headers, body = null
            'GET' !== opts.method && 'HEAD' !== opts.method && (body = new Blob(self._body, { type: (headersObj['content-type'] || {}).value || '' }))
            var headersList = []
            if (Object.keys(headersObj).forEach((function (keyName) {
              var name = headersObj[keyName].name, value = headersObj[keyName].value
              Array.isArray(value) ? value.forEach((function (v) {headersList.push([name, v])})) : headersList.push([name, value])
            })), 'fetch' === self._mode) {
              var signal = null
              if (capability.abortController) {
                var controller = new AbortController
                signal = controller.signal, self._fetchAbortController = controller, 'requestTimeout' in opts && 0 !== opts.requestTimeout && (self._fetchTimer = global.setTimeout((function () {self.emit('requestTimeout'), self._fetchAbortController && self._fetchAbortController.abort()}), opts.requestTimeout))
              }
              global.fetch(self._opts.url, {
                ...
                signal: signal
              }).then((function (response) {self._fetchResponse = response, self._connect()}), (function (reason) {global.clearTimeout(self._fetchTimer), self._destroyed || self.emit('error', reason)}))
            } else {
              var xhr = self._xhr = new global.XMLHttpRequest
              try {xhr.open(self._opts.method, self._opts.url, !0)} catch (err) {return void process.nextTick((function () {self.emit('error', err)}))}
              'responseType' in xhr && (xhr.responseType = self._mode), 'withCredentials' in xhr && (xhr.withCredentials = !!opts.withCredentials), 'text' === self._mode && 'overrideMimeType' in xhr && xhr.overrideMimeType('text/plain; charset=x-user-defined'), 'requestTimeout' in opts && (xhr.timeout = opts.requestTimeout, xhr.ontimeout = function () {self.emit('requestTimeout')}), headersList.forEach((function (header) {xhr.setRequestHeader(header[0], header[1])})), self._response = null, xhr.onreadystatechange = function () {
                switch (xhr.readyState) {
                  case rStates.LOADING:
                  case rStates.DONE:
                    self._onXHRProgress()
                }
              }, 'moz-chunked-arraybuffer' === self._mode && (xhr.onprogress = function () {self._onXHRProgress()}), xhr.onerror = function () {self._destroyed || self.emit('error', new Error('XHR error'))}
              try {xhr.send(body)} catch (err) {return void process.nextTick((function () {self.emit('error', err)}))}
            }
          }
    ...
    }, { './capability': 19, './response': 21, _process: 32, buffer: 28, inherits: 2, 'readable-stream': 17 }],
    21: [function (require, module, exports) {
      (function (process, global, Buffer) {
        var capability = require('./capability'), inherits = require('inherits'), stream = require('readable-stream'),
          ...
          IncomingMessage = exports.IncomingMessage = function (xhr, response, mode, fetchTimer) {
            var self = this
            if (stream.Readable.call(self), self._mode = mode, self.headers = {}, self.rawHeaders = [], self.trailers = {}, self.rawTrailers = [], self.on('end', (function () {process.nextTick((function () {self.emit('close')}))})), 'fetch' === mode) {
              if (self._fetchResponse = response, self.url = response.url, self.statusCode = response.status, self.statusMessage = response.statusText, response.headers.forEach((function (header, key) {self.headers[key.toLowerCase()] = header, self.rawHeaders.push(key, header)})), capability.writableStream) {
                var writable = new WritableStream({
                  write: function (chunk) {return new Promise((function (resolve, reject) {self._destroyed ? reject() : self.push(Buffer.from(chunk)) ? resolve() : self._resumeFetch = resolve}))},
                  close: function () {global.clearTimeout(fetchTimer), self._destroyed || self.push(null)},
                  abort: function (err) {self._destroyed || self.emit('error', err)}
                })
                try {return void response.body.pipeTo(writable).catch((function (err) {global.clearTimeout(fetchTimer), self._destroyed || self.emit('error', err)}))} catch (e) {}
              }
              ...
              !function read () {
                ...
                })).catch((function (err) {global.clearTimeout(fetchTimer), self._destroyed || self.emit('error', err)}))
              }()
            } else {
              if (self._xhr = xhr, self._pos = 0, self.url = xhr.responseURL, self.statusCode = xhr.status, self.statusMessage = xhr.statusText, xhr.getAllResponseHeaders().split(/\r?\n/).forEach((function (header) {
                var matches = header.match(/^([^:]+):\s*(.*)/)
                if (matches) {
                  var key = matches[1].toLowerCase()
                  'set-cookie' === key ? (void 0 === self.headers[key] && (self.headers[key] = []), self.headers[key].push(matches[2])) : void 0 !== self.headers[key] ? self.headers[key] += ', ' + matches[2] : self.headers[key] = matches[2], self.rawHeaders.push(matches[1], matches[2])
                }
        ...
        inherits(IncomingMessage, stream.Readable), IncomingMessage.prototype._read = function () {
          ...
          switch (self._mode) {
            ...
            case'ms-stream':
              ...
              reader.onprogress = function () {reader.result.byteLength > self._pos && (self.push(Buffer.from(new Uint8Array(reader.result.slice(self._pos)))), self._pos = reader.result.byteLength)}, reader.onload = function () {self.push(null)}, reader.readAsArrayBuffer(response)
          }
          self._xhr.readyState === rStates.DONE && 'ms-stream' !== self._mode && self.push(null)
        }
      }).call(this, require('_process'), 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : {}, require('buffer').Buffer)
    }, { './capability': 19, _process: 32, buffer: 28, inherits: 2, 'readable-stream': 17 }],
    22: [function (require, module, exports) {
      (function (global) {
        var ClientRequest = require('./lib/request'), response = require('./lib/response'), extend = require('xtend'),
          statusCodes = require('builtin-status-codes'), url = require('url'), http = exports
        http.request = function (opts, cb) {
          opts = 'string' == typeof opts ? url.parse(opts) : extend(opts)
          var defaultProtocol = -1 === global.location.protocol.search(/^https?:$/) ? 'http:' : '',
            protocol = opts.protocol || defaultProtocol, host = opts.hostname || opts.host, port = opts.port,
            path = opts.path || '/'
          host && -1 !== host.indexOf(':') && (host = '[' + host + ']'), opts.url = (host ? protocol + '//' + host : '') + (port ? ':' + port : '') + path, opts.method = (opts.method || 'GET').toUpperCase(), opts.headers = opts.headers || {}
    ...
    }, { './lib/request': 20, './lib/response': 21, 'builtin-status-codes': 1, url: 37, xtend: 25 }],
    ...
    24: [function (require, module, exports) {
      (function (global) {
        function config (name) {
          try {if (!global.localStorage) return !1} catch (_) {return !1}
    ...
    26: [function (require, module, exports) {
      'use strict'
      exports.byteLength = function (b64) {return 3 * b64.length / 4 - placeHoldersCount(b64)}, exports.toByteArray = function (b64) {
 ...
 */
        ...
        function arrayIndexOf (arr, val, byteOffset, encoding, dir) {
          ...
          if (dir) {
            var foundIndex = -1
            for (i = byteOffset; i < arrLength; i++) if (read(arr, i) === read(val, -1 === foundIndex ? 0 : i - foundIndex)) {if (-1 === foundIndex && (foundIndex = i), i - foundIndex + 1 === valLength) return foundIndex * indexSize} else -1 !== foundIndex && (i -= i - foundIndex), foundIndex = -1
        ...
        Buffer.prototype.slice = function (start, end) {
          ...
          if ((start = ~~start) < 0 ? (start += len) < 0 && (start = 0) : start > len && (start = len), (end = void 0 === end ? len : ~~end) < 0 ? (end += len) < 0 && (end = 0) : end > len && (end = len), end < start && (end = start), Buffer.TYPED_ARRAY_SUPPORT) (newBuf = this.subarray(start, end)).__proto__ = Buffer.prototype else {
          ...
          return val
        }, Buffer.prototype.readUInt8 = function (offset, noAssert) {return noAssert || checkOffset(offset, 1, this.length), this[offset]}, Buffer.prototype.readUInt16LE = function (offset, noAssert) {return noAssert || checkOffset(offset, 2, this.length), this[offset] | this[offset + 1] << 8}, Buffer.prototype.readUInt16BE = function (offset, noAssert) {return noAssert || checkOffset(offset, 2, this.length), this[offset] << 8 | this[offset + 1]}, Buffer.prototype.readUInt32LE = function (offset, noAssert) {return noAssert || checkOffset(offset, 4, this.length), (this[offset] | this[offset + 1] << 8 | this[offset + 2] << 16) + 16777216 * this[offset + 3]}, Buffer.prototype.readUInt32BE = function (offset, noAssert) {return noAssert || checkOffset(offset, 4, this.length), 16777216 * this[offset] + (this[offset + 1] << 16 | this[offset + 2] << 8 | this[offset + 3])}, Buffer.prototype.readIntLE = function (offset, byteLength, noAssert) {
          offset |= 0, byteLength |= 0, noAssert || checkOffset(offset, byteLength, this.length)
          for (var val = this[offset], mul = 1, i = 0; ++i < byteLength && (mul *= 256);) val += this[offset + i] * mul
          ...
          return val >= (mul *= 128) && (val -= Math.pow(2, 8 * byteLength)), val
        }, Buffer.prototype.readInt8 = function (offset, noAssert) {return noAssert || checkOffset(offset, 1, this.length), 128 & this[offset] ? -1 * (255 - this[offset] + 1) : this[offset]}, Buffer.prototype.readInt16LE = function (offset, noAssert) {
          ...
          return 32768 & val ? 4294901760 | val : val
        }, Buffer.prototype.readInt32LE = function (offset, noAssert) {return noAssert || checkOffset(offset, 4, this.length), this[offset] | this[offset + 1] << 8 | this[offset + 2] << 16 | this[offset + 3] << 24}, Buffer.prototype.readInt32BE = function (offset, noAssert) {return noAssert || checkOffset(offset, 4, this.length), this[offset] << 24 | this[offset + 1] << 16 | this[offset + 2] << 8 | this[offset + 3]}, Buffer.prototype.readFloatLE = function (offset, noAssert) {return noAssert || checkOffset(offset, 4, this.length), ieee754.read(this, offset, !0, 23, 4)}, Buffer.prototype.readFloatBE = function (offset, noAssert) {return noAssert || checkOffset(offset, 4, this.length), ieee754.read(this, offset, !1, 23, 4)}, Buffer.prototype.readDoubleLE = function (offset, noAssert) {return noAssert || checkOffset(offset, 8, this.length), ieee754.read(this, offset, !0, 52, 8)}, Buffer.prototype.readDoubleBE = function (offset, noAssert) {return noAssert || checkOffset(offset, 8, this.length), ieee754.read(this, offset, !1, 52, 8)}, Buffer.prototype.writeUIntLE = function (value, offset, byteLength, noAssert) {
        ...
        function toHex (n) {return n < 16 ? '0' + n.toString(16) : n.toString(16)}
        ...
        function base64ToBytes (str) {
          return base64.toByteArray(function (str) {
            if ((str = function (str) {return str.trim ? str.trim() : str.replace(/^\s+|\s+$/g, '')}(str).replace(INVALID_BASE64_RE, '')).length < 2) return ''
    ...
    }, { 'base64-js': 26, ieee754: 30, isarray: 31 }],
    29: [function (require, module, exports) {
      ...
      module.exports = EventEmitter, EventEmitter.EventEmitter = EventEmitter, EventEmitter.prototype._events = void 0, EventEmitter.prototype._maxListeners = void 0, EventEmitter.defaultMaxListeners = 10, EventEmitter.prototype.setMaxListeners = function (n) {
        ...
        } else if (isObject(handler)) for (args = Array.prototype.slice.call(arguments, 1), len = (listeners = handler.slice()).length, i = 0; i < len; i++) listeners[i].apply(this, args)
        return !0
        ...
        if (length = (list = this._events[type]).length, position = -1, list === listener || isFunction(list.listener) && list.listener === listener) delete this._events[type], this._events.removeListener && this.emit('removeListener', type, listener) else if (isObject(list)) {
      ...
      }, EventEmitter.prototype.listeners = function (type) {return this._events && this._events[type] ? isFunction(this._events[type]) ? [this._events[type]] : this._events[type].slice() : []}, EventEmitter.prototype.listenerCount = function (type) {
        if (this._events) {
      ...
      function drainQueue () {
        if (!draining) {
          ...
          currentQueue = null, draining = !1, function (marker) {
            ...
            try {cachedClearTimeout(marker)} catch (e) {try {return cachedClearTimeout.call(null, marker)} catch (e) {return cachedClearTimeout.call(this, marker)}}
          }(timeout)
        }
      }
    ...
    33: [function (require, module, exports) {
      (function (global) {
        !function (root) {
          ...
          var punycode, key, maxInt = 2147483647, regexPunycode = /^xn--/, regexNonASCII = /[^\x20-\x7E]/,
          ...
          function digitToBasic (digit, flag) {return digit + 22 + 75 * (digit < 26) - ((0 != flag) << 5)}
          ...
          function decode (input) {
            var out, basic, j, index, oldi, w, k, digit, t, baseMinusT, codePoint, output = [],
              inputLength = input.length, i = 0, n = 128, bias = 72
            for ((basic = input.lastIndexOf('-')) < 0 && (basic = 0), j = 0; j < basic; ++j) input.charCodeAt(j) >= 128 && error('not-basic'), output.push(input.charCodeAt(j))
            for (index = basic > 0 ? basic + 1 : 0; index < inputLength;) {
              for (oldi = i, w = 1, k = 36; index >= inputLength && error("invalid-input"), ((digit = (codePoint = input.charCodeAt(index++)) - 48 < 10 ? codePoint - 22 : codePoint - 65 < 26 ? codePoint - 65 : codePoint - 97 < 26 ? codePoint - 97 : 36) >= 36 || digit > floor((maxInt - i) / w)) && error("overflow"), i += digit * w, !(digit < (t = k <= bias ? 1 : k >= bias + 26 ? 26 : k - bias)); k += 36) w > floor(maxInt / (baseMinusT = 36 - t)) && error('overflow'), w *= baseMinusT
          ...
          function encode (input) {
            ...
            for (inputLength = (input = ucs2decode(input)).length, n = 128, delta = 0, bias = 72, j = 0; j < inputLength; ++j) (currentValue = input[j]) < 128 && output.push(stringFromCharCode(currentValue))
            for (handledCPCount = basicLength = output.length, basicLength && output.push('-'); handledCPCount < inputLength;) {
              ...
              for (m - n > floor((maxInt - delta) / (handledCPCountPlusOne = handledCPCount + 1)) && error('overflow'), delta += (m - n) * handledCPCountPlusOne, n = m, j = 0; j < inputLength; ++j) if ((currentValue = input[j]) < n && ++delta > maxInt && error('overflow'), currentValue == n) {
                for (q = delta, k = 36; !(q < (t = k <= bias ? 1 : k >= bias + 26 ? 26 : k - bias)); k += 36) qMinusT = q - t, baseMinusT = 36 - t, output.push(stringFromCharCode(digitToBasic(t + qMinusT % baseMinusT, 0))), q = floor(qMinusT / baseMinusT)
          ...
          if (punycode = {
            ...
            decode: decode,
            encode: encode,
            toASCII: function (input) {return mapDomain(input, (function (string) {return regexNonASCII.test(string) ? 'xn--' + encode(string) : string}))},
            toUnicode: function (input) {return mapDomain(input, (function (string) {return regexPunycode.test(string) ? decode(string.slice(4).toLowerCase()) : string}))}
    ...
    34: [function (require, module, exports) {
      ...
      var isArray = Array.isArray || function (xs) {return '[object Array]' === Object.prototype.toString.call(xs)}
    }, {}],
    35: [function (require, module, exports) {
      ...
      module.exports = function (obj, sep, eq, name) {
        return sep = sep || '&', eq = eq || '=', null === obj && (obj = void 0), 'object' == typeof obj ? map(objectKeys(obj), (function (k) {
          ...
          return isArray(obj[k]) ? map(obj[k], (function (v) {return ks + encodeURIComponent(stringifyPrimitive(v))})).join(sep) : ks + encodeURIComponent(stringifyPrimitive(obj[k]))
    ...
    37: [function (require, module, exports) {
      ...
      exports.parse = urlParse, exports.resolve = function (source, relative) {return urlParse(source, !1, !0).resolve(relative)}, exports.resolveObject = function (source, relative) {return source ? urlParse(source, !1, !0).resolveObject(relative) : relative}, exports.format = function (obj) {
      ...
      var protocolPattern = /^([a-z0-9.+-]+:)/i, portPattern = /:[0-9]*$/,
        ...
        hostEndingChars = ['/', '?', '#'], hostnamePartPattern = /^[+a-z0-9A-Z_-]{0,63}$/,
      ...
      Url.prototype.parse = function (url, parseQueryString, slashesDenoteHost) {
        ...
        var queryIndex = url.indexOf('?'), splitter = -1 !== queryIndex && queryIndex < url.indexOf('#') ? '?' : '#',
        ...
        return protocol && ':' !== protocol.substr(-1) && (protocol += ':'), this.slashes || (!protocol || slashedProtocol[protocol]) && !1 !== host ? (host = '//' + (host || ''), pathname && '/' !== pathname.charAt(0) && (pathname = '/' + pathname)) : host || (host = ''), hash && '#' !== hash.charAt(0) && (hash = '#' + hash), search && '?' !== search.charAt(0) && (search = '?' + search), protocol + host + (pathname = pathname.replace(/[?#]/g, (function (match) {return encodeURIComponent(match)}))) + (search = search.replace('#', '%23')) + hash
      }, Url.prototype.resolve = function (relative) {return this.resolveObject(urlParse(relative, !1, !0)).format()}, Url.prototype.resolveObject = function (relative) {
    ...
    }, { './util': 38, punycode: 33, querystring: 36 }],
    38: [function (require, module, exports) {
      'use strict'
      module.exports = {
        isString: function (arg) {return 'string' == typeof arg},
        isObject: function (arg) {return 'object' == typeof arg && null !== arg},
        isNull: function (arg) {return null === arg},
        isNullOrUndefined: function (arg) {return null == arg}
      }
    }, {}]
  }, {}, [22])(22)
}))